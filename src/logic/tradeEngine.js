...
export const TRADE_CODES_INFO = {
    Ag: { name_en: 'Agricultural', name_jp: '農業' },
    As: { name_en: 'Asteroid', name_jp: '小惑星' },
    Ba: { name_en: 'Barren', name_jp: '不毛' },
    Cp: { name_en: 'Subsector Capital', name_jp: 'サブセクター首都' },
    Cs: { name_en: 'Sector Capital', name_jp: 'セクター首都' },
    Cx: { name_en: 'Capital', name_jp: '首都' },
    Da: { name_en: 'Danger', name_jp: '危険' },
    De: { name_en: 'Desert', name_jp: '砂漠' },
    Fa: { name_en: 'Farming', name_jp: '農耕' },
    Fl: { name_en: 'Fluid Oceans', name_jp: '流体海' },
    Ga: { name_en: 'Garden', name_jp: '楽園' },
    Hi: { name_en: 'High Population', name_jp: '高人口' },
    Ht: { name_en: 'High Tech', name_jp: 'ハイテク' },
    Ic: { name_en: 'Ice-Capped', name_jp: '氷結' },
    In: { name_en: 'Industrial', name_jp: '工業' },
    Lo: { name_en: 'Low Population', name_jp: '低人口' },
    Lt: { name_en: 'Low Tech', name_jp: 'ローテク' },
    Na: { name_en: 'Non-Agricultural', name_jp: '非農業' },
    Ni: { name_en: 'Non-Industrial', name_jp: '非工業' },
    Po: { name_en: 'Poor', name_jp: '貧困' },
    Pr: { name_en: 'Pre-Agricultural', name_jp: '前農業' },
    Px: { name_en: 'Prison, Exile Camp', name_jp: '監獄/流刑地' },
    Ri: { name_en: 'Rich', name_jp: '富裕' },
    Rs: { name_en: 'Research Station', name_jp: '研究所' },
    Va: { name_en: 'Vacuum', name_jp: '真空' },
    Wa: { name_en: 'Water World', name_jp: '海洋' },
};
