...
export const TRADE_CODES_INFO = {
    ...
    Pr: { name_en: 'Pre-Agricultural', name_ja: '前農業' },
    Px: { name_en: 'Prison, Exile Camp', name_ja: '監獄/流刑地' },
